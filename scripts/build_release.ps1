...
try {
    ...
    foreach ($Required in @(
        ...
        "plugins/figure-skill/skills/figure-skill/scripts/capability_cli.py",
        "plugins/figure-skill/skills/figure-skill/scripts/backends/plotting/renderer.py",
        "plugins/figure-skill/skills/figure-skill/scripts/planning/schema.py",
        "plugins/figure-skill/skills/figure-skill/scripts/quality/report.py",
        ...
        "plugins/figure-skill/skills/figure-skill/scripts/backends/raster_annotation_backend.py",
        "plugins/figure-skill/skills/figure-skill/scripts/audit_hybrid_svg.py",
        "plugins/figure-skill/skills/figure-skill/scripts/bootstrap_external_backends.py",
        "plugins/figure-skill/skills/paperbanana/SKILL.md",
        "plugins/figure-skill/skills/autofigure-edit/SKILL.md",
